...
const Navbar = ({profile}) => {
 ...
 const handleLogout = useCallback(() => {
  ...
  return (
   <nav className="absolute bg-black  max-w-[1600px] mx-auto top-0 left-0 w-full z-50   border-gray-600/50 px-5 sm:px-8 py-5 flex items-center justify-between min-[1800px]:relative">

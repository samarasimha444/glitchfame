    ...
    <>
     ...
     <div className="p-4 w-full justify-between border-b border-gray-800 flex  items-center">
        ...
        <section className="flex space-x-4 text-[13px]">
            <p className="rounded-4xl cursor-pointer border border-gray-600 px-3 py-1">All</p>
            <p className="rounded-4xl cursor-pointer border border-gray-600 px-3 py-1">Active</p>
            <p className="rounded-4xl cursor-pointer border border-gray-600 px-3 py-1">Ended</p>
        </section>
      </div>

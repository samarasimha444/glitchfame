...
const ArenaCard = ({seasonId,contestantsData = { content: [] },isLoading, isError,}) => {
  ...
  return (
    <section className="flex flex-col w-full  sm:px-6 md:pb-20">
      <div className="w-full  mx-auto">
        ...
        {isError || (!isLoading && contestantsData.length === 0) ?
          <Error />
...
{!isLoading &&
  contestantsData?.contestants?.map((user) => (
    <div key={user.participationId} className="flex flex-col items-center">

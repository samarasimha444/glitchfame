    ...
    <div className="w-full mt-4 py-3 mb-4 md:py-24 flex justify-center">
      <div className="w-full max-w-7xl px-2 md:px-16 flex flex-col md:flex-row justify-between gap-6 sm:gap-12 md:gap-20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              ...
              className="bg-primary text-xs sm:text-base text-black px-6 py-3 md:font-semibold hover:opacity-90 transition w-full sm:w-auto"
            >
              START SUBMISSION
            </button>
            ...
            <button
              ...
              className="border text-xs sm:text-base border-gray-600 px-6 py-3 font-semibold hover:border-white hover:text-primary transition w-full sm:w-auto"
            >
              HOW IT WORKS
            </button>
          </div>
        ...
        <motion.div
          ...
          className="w-full md:w-1/2 grid grid-cols-2 sm:grid-cols-2 gap-6"
        >

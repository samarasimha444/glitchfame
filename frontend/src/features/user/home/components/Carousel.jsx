...
export default function FeaturedCarousel({ season }) {
  return (
    <div className="w-full max-h-dvh relative mt-6 md:mt-0 flex justify-center items-center  max-w-400 mx-auto  h-full md:max-h-[95dvh]">
      ...
      <section className="border border-gray-600 rounded-xl md:rounded-none w-full max-w-90 sm:max-w-screen sm:h-120 md:h-170 relative overflow-hidden aspect-16\/9">
        <img
  ...
  <h1
  className="
    uppercase mt-6 font-black max-w-4xl
    text-5xl sm:text-6xl md:text-7xl lg:text-8xl
    leading-[0.9] tracking-tight

    bg-gradient-to-b from-white via-white to-[#6A7282]
    bg-clip-text text-transparent

    drop-shadow-[0_8px_24px_rgba(255,255,255,0.15)]
  "
>

...
const Approval = ({ className }) => {
  ...
  return (
    <div className={`w-full bg-[#0f1115] flex justify-center ${className}`}>
      <div className="w-full max-w-full bg-[#1a1f2b] 
      
      
      
      
      rounded-2xl p-4 sm:p-6 shadow-xs border border-gray-800">
          ...
          {contestants.map((user) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 mt-2 sm:mt-0">
                <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-black border border-gray-600 text-white px-4 py-2 rounded-lg hover:border-gray-400 transition">
                  <CheckCircle size={16} />
                  Approve
                </button>

                <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-black border border-red-600 text-red-500 px-4 py-2 rounded-lg hover:bg-red-600 hover:text-white transition">
                  <XCircle size={16} />
                  Reject
                </button>
              </div>
